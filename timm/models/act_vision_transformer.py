...
from AViT.timm.data import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, IMAGENET_INCEPTION_MEAN, IMAGENET_INCEPTION_STD
...
from AViT.utils import get_distribution_target
...
class VisionTransformer(BaseBackbone):
    ...
    def forward_features_act_token0(self, x):
