...
from evaluation.datasets.visdronedataset import VISDRONE


class ExperimentVISDRONE(object):
    ...
    def __init__(self, root_dir, result_dir='results', report_dir='reports'):
        self.dataset = VISDRONE(root_dir)
        self.result_dir = os.path.join(result_dir, 'visdrone')
        self.report_dir = os.path.join(report_dir, 'visdrone')
