...
from evaluation.datasets.uavtrackdataset import UAVTrack
from evaluation.utils.metrics import rect_iou, center_error


class ExperimentUAVTRACK(object):
    ...
    def __init__(self, root_dir, result_dir='results', report_dir='reports'):
        self.dataset = UAVTrack(root_dir)
        self.result_dir = os.path.join(result_dir, 'uavtrack')
        self.report_dir = os.path.join(report_dir, 'uavtrack')
