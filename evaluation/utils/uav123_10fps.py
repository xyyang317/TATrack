...
from evaluation.datasets.uav123_10fpsdataset import UAV123_10fps


class ExperimentUAV123_10fps(object):
    ...
    def __init__(self, root_dir, result_dir='results', report_dir='reports'):
        self.dataset = UAV123_10fps(root_dir)
        self.result_dir = os.path.join(result_dir, 'uav123_10fps')
        self.report_dir = os.path.join(report_dir, 'uav123_10fps')
